...
/*    setState(() {
    ...
    Provider.of<ServiceProvider>(context, listen: false)
        .getInvestmentRecommendationList(
  ...
  updateAnalystsList() {
    ...
    Provider.of<ServiceProvider>(context, listen: false)
      ...
      searchQuery: _searchController.text
        ...
        .then((value) {
      setState(() {
        analystsListModel = Provider.of<ServiceProvider>(context, listen: false)
            .analystsInvestmentModel;

        print("HEREDATARE CEIR");
        print(analystsListModel!.data);
        _isLoading = false;
      });
    });
    /* Provider.of<ServiceProvider>(context, listen: false)
    ...
    return Row(
      children: [
        ...
        TextButton(
          ...
          child: Text(
            AppLocalizations.of(context)!.investmentLists,
