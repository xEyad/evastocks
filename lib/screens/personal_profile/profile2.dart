...
class _Profile2State extends State<Profile2> {
  late Future _getProfile2 =
      Provider.of<ServiceProvider>(context, listen: false).getProfile2(context: context);
  ...
  updateMyRecs() {
    ...
    //         status: analyticsFilter == 'hold'
    //             ? '3'
    //             : analyticsFilter == 'success'
    //                 ? '1'
    //                 : analyticsFilter == 'failed'
    //                     ? '2'
    //                     : null)
    //     .then((value) {
    //   setState(() {
    ...
    //           .where((item) => /*item['is_mine'] == 1 &&*/
    //               (analyticsFilter == 'hold'
    //                   ? item['recommendationStatus'] ==
    //                       AppLocalizations.of(context)!.awaiting
    //                   : analyticsFilter == 'success'
    //                       ? item['recommendationStatus'] ==
  ...
  updateMyRecsWithPagination() {
    ...
    //           value['data'].where((item) => item['is_mine'] == 1).toList());
    //     } else {
                  ...
                  Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            snapshot.data['data']['about_me'].isEmpty
                                ? '${AppLocalizations.of(context)!.descNotFound}'
                                : snapshot.data['data']['about_me'] ??
                                    '${AppLocalizations.of(context)!.descNotFound}',
                            style: const TextStyle(
                                fontWeight: FontWeight.w400,
                                color: kSecondColor,
